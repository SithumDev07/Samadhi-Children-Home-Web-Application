...
<body>
    <main class="h-screen">
        ...
        <h1 class="text-8xl font-extralight text-gray-500 text-center">Database isn't Connected</h1>
        <h1 class="text-xl font-semibold text-blue-500 text-center mt-10">👀 Look inside database.php</h1>
        </div>
    </main>
